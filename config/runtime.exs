...
#
#     PHX_SERVER=true bin/phoenix_vue_template start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :phoenix_vue_template, PhoenixVueWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :phoenix_vue_template, PhoenixVue.Repo,
    # ssl: true,
    url: database_url,
  ...
  config :phoenix_vue_template, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :phoenix_vue_template, PhoenixVue.Mailer,
